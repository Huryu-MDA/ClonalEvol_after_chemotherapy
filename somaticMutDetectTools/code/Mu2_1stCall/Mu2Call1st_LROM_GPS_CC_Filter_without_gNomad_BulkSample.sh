...
bsub -W 24:00 -q medium -n 3 -M 80G -R rusage[mem=80] -e ${StoreDir}/MergeVCF_err.log -o ${StoreDir}/MergeVCF_out.log \
     -w "${MutectCallDoneSignal}" \
     -J "MergeVCF_${Tag}_${TimeID}" \
     "${GATKver} MergeVcfs ${all_UnFilvcf} \
                         -O ${StoreDir}/${Tag}.merged.unfiltered.vcf"

bsub -W 24:00 -q medium -n 3 -M 80G -R rusage[mem=80] -e ${StoreDir}/MMS_err.log -o ${StoreDir}/MMS_out.log \
     -w "${MutectCallDoneSignal}" \
     -J "MMS_${Tag}_${TimeID}" \
     "${GATKver} MergeMutectStats ${all_UnFilvcfStats} \
                                -O ${StoreDir}/${Tag}.merged.stats"

bsub -W 24:00 -q medium -n 3 -M 80G -R rusage[mem=80] -e ${StoreDir}/LROM_err.log -o ${StoreDir}/LROM_out.log \
     -w "${MutectCallDoneSignal}" \
...
bsub -W 24:00 -q medium -n 2 -M 80G -R rusage[mem=80] -e ${StoreDir}/${Tag}_FMC_err.log -o ${StoreDir}/${Tag}_FMC_out.log \
